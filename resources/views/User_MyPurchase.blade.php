  ...
  <div id="mobileMenu" class="md:hidden overflow-hidden">
    ...
    <div class="container mx-auto max-w-7xl p-6">
        ...
        <div class="flex gap-4 mb-6">
            ...
            <a href="/U_MyPurchase" class="px-6 py-2 bg-blue-700 border-3 border-blue-900 text-white rounded-full font-medium">
                My Purchase
            </a>
            <a href="./U_OrderHistory" class="px-6 py-2.5 text-gray-700 hover:text-gray-900 font-medium">
                Order History
            </a>
        </div>
