...
<div class="flex">
    ...
    <main class="flex-1 mt-16 p-6 md:ml-64 transition-all duration-300">
        ...
        <!-- ── PAGE HEADING + THIS WEEK DROPDOWN ────────── -->
        <div class="flex items-center justify-between mb-5">
            <h2 class="text-lg font-semibold text-gray-800">Sales Overview</h2>

            <!-- This Week dropdown -->
            <div class="relative">
                <select class="appearance-none bg-white border border-gray-200 rounded-lg pl-3 pr-8 py-1.5 text-sm text-gray-600 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-300">
                    <option>This Week</option>
                    <option>Last Week</option>
                    <option>This Month</option>
                    <option>Last Month</option>
                </select>
                <svg class="w-4 h-4 text-gray-400 absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            <div class="card bg-white rounded-xl p-5 flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">₱500,230</p>
        ...
        <div class="card bg-white rounded-xl p-5 mb-6">
            <h2 class="text-sm font-semibold text-gray-800 mb-4">Sales Overview</h2>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    new Chart(document.getElementById('salesChart').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                data: [48000, 72000, 65000, 80000, 120000, 135000, 118000],
                borderColor: '#3b82f6',
